...
vim.g.bufferline_diagnostics = "nvim_lsp"
...
-- usellection of configurations for built-in LSP client
use "neovim/nvim-lspconfig"
use "ray-x/cmp-treesitter"
-- usev setup for init.lua and plugin development with full signature help, docs
-- used completion for the nvim lua API.
